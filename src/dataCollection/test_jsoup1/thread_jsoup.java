package dataCollection.test_jsoup1;
...
/////////////////////////////////////////////////////////////////////////////////// ´º½º Å©·Ñ¸µ°ú ÇØ½Ã
			...
			String naver_url = "https://searc"
					+ "h.naver.com/search.naver?date_from=&date_option=0&date_to=&dup_remove=1&nso=&post_blogurl=&post_blogurl_without=&query=%EB%8D%B0%EC%9D%B4%ED%84%B0%EB%A7%88%EC%9D%B4%EB%8B%9D&sm=tab_pge&srchby=all&st=sim&where=post&start=";
