...
public class UserController {
	...
	public String main_login(HttpServletRequest request, HttpServletResponse response, ModelMap model)
			throws Exception {
	...
	// 회원가입 페이지
	@RequestMapping(value = "main_reg")
	public String main_reg(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {

		return "/user/reg";
	}

	// 아이디찾기 페이지
	@RequestMapping(value = "main_find")
	public String main_find(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
