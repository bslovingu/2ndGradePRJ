...
public class EncryptUtil {
	...
	/**
	 * 해시 알고리즘(단방향 암호와 알고리즘) -SHA-256
	 * 
	 * @param 암호화 시킬 값
	 * @return 암호화 된 값
	 */
	public static String encHashSHA256(String str) throws Exception {
		String res = ""; // 암호화 결과값이 저장되느는 변수
		String plantText = addMessage + str; // 암호화 시킬 값에 보안강화를 위해 임의 값을 추가
		try {
	 ...
	 * AES128 CBC 암호화 함수
	 * 
	 * 128은 암호화 키 길이를 의미함 128비트는 16바이트(1바이트=8비트, 8*16 = 128)
	 */
