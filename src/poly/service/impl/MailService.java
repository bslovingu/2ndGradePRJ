...
public class MailService implements IMailService {
	...
	final String user = "jaeyoonjeong2651@gmail.com";
	final String password = "go89059709";
	...
	public int doSendContact(MailDTO pDTO) throws Exception {
		...
		try {
			...
			message.addRecipient(Message.RecipientType.TO, new InternetAddress("jaeyoonjeong2651@gmail.com"));
